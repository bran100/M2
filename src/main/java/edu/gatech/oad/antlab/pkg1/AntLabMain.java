 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint =
		  ...
		  Person1 p1 = new Person1("Nenad Stanic");
		  toPrint += p1.toString("903216591");
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Daisha White");
		  toPrint += p2.toString("903220216");
		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("Bowen Ran");
		  toPrint += p3.toString("903358210");
                  //Person4 replace P4 with your name
                  //and gburdell4 with your gt id
                  Person4 p4 = new Person4("Armand Raynor");
                  toPrint += p4.toString("902969165");
                  ...
                  Person6 p6 = new Person6("Samantha Mann");
                  toPrint += p6.toString("903149599");
